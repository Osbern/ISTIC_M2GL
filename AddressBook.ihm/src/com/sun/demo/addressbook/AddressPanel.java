...
public class AddressPanel extends javax.swing.JPanel {
	...
	private class EditedListener implements DocumentListener {
		...
		public void removeUpdate(DocumentEvent e) {
			af.textModified();
			if (txtAddress1.getText().isEmpty() && txtAddress2.getText().isEmpty() && txtCity.getText().isEmpty() && txtState.getText().isEmpty()
					&& txtPostalCode.getText().isEmpty() && txtLastName.getText().isEmpty() && txtFirstName.getText().isEmpty()
					&& txtMiddleName.getText().isEmpty() && txtPhone.getText().isEmpty() && txtEmail.getText().isEmpty() && txtCountry.getText().isEmpty()) {
				af.textEmpty();
			}
		}
	...
	public AddressPanel(AddressFrame af) {
		initComponents();
		address = new Address();
		this.af = af;
	}

	public void setAf(AddressFrame af) {
		this.af = af;
	}
	...
	private void initComponents() {
		...
		EditedListener el = new EditedListener();

		lblAddress1 = new javax.swing.JLabel();
		txtAddress1 = new javax.swing.JTextField();
		txtAddress1.getDocument().addDocumentListener(el);

		lblAddress2 = new javax.swing.JLabel();
		txtAddress2 = new javax.swing.JTextField();
		txtAddress2.getDocument().addDocumentListener(el);

		lblCity = new javax.swing.JLabel();
		txtCity = new javax.swing.JTextField();
		txtCity.getDocument().addDocumentListener(el);

		txtState = new javax.swing.JTextField();
		txtState.getDocument().addDocumentListener(el);

		txtPostalCode = new javax.swing.JTextField();
		txtPostalCode.getDocument().addDocumentListener(el);

		lblState = new javax.swing.JLabel();
		lblPostalCode = new javax.swing.JLabel();
		lblLastName = new javax.swing.JLabel();
		txtLastName = new javax.swing.JTextField();
		txtLastName.getDocument().addDocumentListener(el);

		lblFirstName = new javax.swing.JLabel();
		txtFirstName = new javax.swing.JTextField();
		txtFirstName.getDocument().addDocumentListener(el);

		lblMiddleName = new javax.swing.JLabel();
		txtMiddleName = new javax.swing.JTextField();
		txtMiddleName.getDocument().addDocumentListener(el);

		lblPhone = new javax.swing.JLabel();
		txtPhone = new javax.swing.JTextField();
		txtPhone.getDocument().addDocumentListener(el);

		lblEmail = new javax.swing.JLabel();
		txtEmail = new javax.swing.JTextField();
		txtEmail.getDocument().addDocumentListener(el);

		lblCountry = new javax.swing.JLabel();
		txtCountry = new javax.swing.JTextField();
		txtCountry.getDocument().addDocumentListener(el);
